    ...
    <div className="container mx-auto p-6">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Discover volunteer opportunities and share your experience with the community.
        </p>
      </div>
      ...
      {!selectedProject ? (
          ...
          {projects.map((project) => (
            <Card key={project.id} className="cursor-pointer hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                ...
                <Button className="w-full mt-4 bg-gradient-to-r from-[#0EA5E9] to-[#0284C7] hover:from-[#0EA5E9]/90 hover:to-[#0284C7]/90" onClick={() => handleProjectSelect(project)}>
                  View Details & Rate
                </Button>
              </CardContent>
            </Card>
        ...
        <div className="max-w-4xl mx-auto">
          <Button variant="outline" className="mb-6 bg-transparent" onClick={() => setSelectedProject(null)}>
            ← Back to Projects
          </Button>
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-muted-foreground">
                          ({getAverageRating(ratings)}/5 from {ratings.length} reviews)
                        </span>
                      </div>
                    </div>
                  </div>
            ...
            <div>
              <Card className="sticky top-6">
                <CardHeader>
                  ...
                  <CardDescription>Rate this project and leave a comment for the community.</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div>
                  ...
                  <Button className="w-full bg-gradient-to-r from-[#0EA5E9] to-[#0284C7] hover:from-[#0EA5E9]/90 hover:to-[#0284C7]/90" onClick={handleSubmitRating} disabled={submitting}>
