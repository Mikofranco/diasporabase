...
export function AgencyLoadingSkeleton() {
  return (
            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-gray-100/80 border-b hover:bg-gray-100/80">
                  <TableHead className="text-gray-400 font-medium">Organization Name</TableHead>
                  <TableHead className="text-gray-400 font-medium">Contact Email</TableHead>
                  <TableHead className="text-gray-400 font-medium">Website</TableHead>
                  <TableHead className="text-gray-400 font-medium">Focus Areas</TableHead>
...
export function AgencyTableSkeleton() {
  return (
    <div className="overflow-x-auto">
      <Table>
        <TableHeader>
